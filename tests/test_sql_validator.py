"""Tests for src.utils.validators.sql_validator."""
from __future__ import annotations

import pytest

from src.utils.validators.sql_validator import validate_sql_conditions, validate_sql_safety
...
class TestValidateSqlSafety:
    ...
    def test_keyword_in_value_is_blocked(self) -> None:
        # "DELETE" as a standalone keyword is blocked even in string context
        assert validate_sql_safety("supplier_name = 'DELETE'") is False
