...
3. execute_sql_query(sql_query: str, limit: int = 50, require_photo: bool = False) → str
...
1. Используй require_photo=True в vector_search, execute_sql_query, get_random_products когда:
