...
- ВАЖНО: Найди товары С ФОТОГРАФИЯМИ (добавь условие photo IS NOT NULL AND photo != '')
- Найди ТОЧНО 2 товара с фото (или 2 товара, если товаров с фото меньше)
- Для каждого товара рассчитай финальную цену по правилам из промпта

ШАГ 2: ОБЯЗАТЕЛЬНО отправь фото товаров!

ШАГ 3: Сформируй приветственное сообщение
...
- Для каждого из 2 товаров укажи:
